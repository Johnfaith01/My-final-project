...
function Detail() {
  return (
    <section className="flex flex-col md:grid md:grid-cols-2 w-[90%] mx-auto gap-4 mb-10 flex-wrap">
        <div>
        ...
        <div className="w-[90%] mx-auto flex flex-col gap-3 mt-5">
            ...
            <h1 className="text-5xl font-light">More than a hotel <br /> <span className="text-slider">a feeling</span></h1>
            <p className="">"Located in the heart of the city, Larita was built on a single conviction: that true luxury is not measured in marble or thread count, but in how a place makes you feel."</p>
