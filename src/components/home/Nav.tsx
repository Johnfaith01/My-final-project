    ...
    return (
        <section className="flex items-center justify-between px-10 py-5">
            ...
            <nav className="flex gap-10 text-sm font-bold text-[15px] text-white">
                ...
                <Link to="/" className="hover:text-[#B8924A]">CONTACT</Link>
            </nav>

            <div className="flex gap-4">
                <Link to="/login"><input type="submit" value='SIGN IN' className='rounded-md border-slate border text-[12px] w-24 font-bold py-2 px-5 cursor-pointer text-white'>
                </input></Link>
