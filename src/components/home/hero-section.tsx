...
function HeroSection() {
    return (
        <>
            <section className="flex flex-col gap-7 justify-center items-center min-h-[80vh] relative pt-30">
                ...
                <Fade delay={500} triggerOnce>
                    <div className="absolute bottom-0 left-10 right-0 top-130.5 flex gap-5">
                        <div className="flex ">
                            <span>
                    ...
                    <div className="flex items-center gap-5 absolute bottom-0 right-10 top-135.5 text-white">
