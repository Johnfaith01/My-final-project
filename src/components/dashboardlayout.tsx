    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-5 min-h-screen">
            ...
            <main className="col-span-1 md:col-span-4 h-screen overflow-y-auto">
                ...
                <header className="flex items-center justify-between gap-3 px-3 sm:px-5 bg-[#12100D] min-h-[70px]">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <button
                            ...
                            className="md:hidden text-white p-2 rounded-md hover:bg-[#201d1a] transition-all shrink-0"
                            aria-label={
                                menuOpen
                                    ? "Close menu"
                                    : "Open menu"
                            ...
                            {links.map((link) => (
                                ...
                                <h1
                                    ...
                                    className={`
                                        ...
                                        text-[#F4EFE4]
                                        truncate
                                        ${path.pathname.startsWith(link.pathname)
                                            ? "block"
                                            : "hidden"
                                        }
                                    `}
                ...
                {/* PAGE CONTENT */}
                <div className="p-3 sm:p-4 bg-[#0A0806] min-h-screen mb-10">
